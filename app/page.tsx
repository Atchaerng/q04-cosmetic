    ...
    <>
      ...
      <div className='sm:flex md:flex lg:flex xl:flex'>
        <div>
          ...
          <div className='text-3xl font-bold '>รายการสินค้า</div>
          <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 p-2'>
        ...
        <section className="w-1/3 pl-2">
          <h2 className="text-3xl font-bold">ตะกร้าสินค้า</h2>
          <table className="w-full table-auto bg-white-800 border">
            <thead>
